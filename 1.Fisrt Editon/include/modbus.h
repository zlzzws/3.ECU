...
typedef struct {
    int nb_bits;  //the number of coil register
    int start_bits;  //the  coil start bit
    int nb_input_bits; 
    int start_input_bits;//Discretes Input
    int nb_input_registers;
    int start_input_registers; // input register start address
    int nb_registers;
    int start_registers;   //the hold register start address
    uint8_t *tab_bits;     //coil array 
    uint8_t *tab_input_bits;
    uint16_t *tab_input_registers;//Register 1000
    uint16_t *tab_registers;//Register  8000
} modbus_mapping_t;

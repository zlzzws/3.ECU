...
*********************************************************************/
#define BRAMERR_NUM 5 	/*read 10 time ,the all data is 0*/
#define MAPERR_NUM 3 	/*map 3 time ,if failed */
#define CAN0_TYPE 0
#define CAN1_TYPE 1
#define CAN0_READ_FRAME_NUM  20
#define CAN0_WRITE_FRAME_NUM 4
#define CAN1_READ_FRAME_NUM  15
#define CAN1_WRITE_FRAME_NUM 5
...
int8_t 	MVB_Bram_Write_Func(BRAM_CMD_PACKET *mvb_packet_wr,TMS570_BRAM_DATA *bram_data_mvb_wr,ECU_ERROR_INFO *ECU_ERROR_INFO);
int8_t  MVB_Bram_Read_Func(BRAM_CMD_PACKET *mvb_packet_rd,TMS570_BRAM_DATA *bram_data_mvb_rd,ECU_ERROR_INFO *ECU_ERROR_INFO);
